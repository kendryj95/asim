...
class ResumenSaldoModel extends CI_Model{
    ...
    function obtenerResumenSaldoFavor($empOrigen, $empDestino){
        ...
        $string = "SELECT * FROM reporte_empresas WHERE id_empresa=$empOrigen AND (descripcion=1 OR descripcion=4) AND ((origen=$empOrigen AND destino=$empDestino) OR (origen=$empDestino AND destino=$empOrigen))";
    ...
    function obtenerResumenSaldoContra($empOrigen, $empDestino){
        ...
        $string = "SELECT * FROM reporte_empresas WHERE id_empresa=$empOrigen AND (descripcion=2 OR descripcion=3) AND ((origen=$empOrigen AND destino=$empDestino) OR (origen=$empDestino AND destino=$empOrigen))";
